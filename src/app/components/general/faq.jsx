                ...
                >
                  ...
                  >
                    <div className="p-4 sm:p-5 md:p-6 bg-[var(--lite-sand)]">
                      ...
                      {item.file && (
                        <div className="mt-4">
                          <FlipbookTrigger pdfUrl={item.file} title={item.question || "Document"}>
                            <button className="px-5 py-2.5 bg-[var(--button-red)] text-white font-medium rounded-lg shadow hover:bg-[var(--dark-orange-red)] transition-colors flex items-center gap-2 font-plus-jakarta-sans">
                      ...
                      {item.image && (
                        <div className="mt-4 w-full flex justify-center">
                          <img src={item.image} alt={item.question || "FAQ Image"} className="w-full max-w-4xl rounded-lg shadow-sm h-auto object-contain" />
                        </div>
                      )}
                    </div>
                  </div>
