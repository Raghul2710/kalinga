...
const mainIntroContent = {
    ...
    imageUrl: "https://s3.ap-south-1.amazonaws.com/cdn.kalingauniversity.ac.in/sdg-cell/Energy+Conservation/s-1-1.webp",
            ...
            <div className="w-full mt-4">
                <DataTable
                    columns={[
                        ...
                        { key: "totalConsumed", label: "Total Electricity Consumed (Grid+RE) (kWh)", widthPx: 250 },
                        { key: "reInstalled", label: "Total Renewable Energy (RE) Power Installed (Solar + Wind + Others) (kWp)", widthPx: 280 },
                        { key: "reGenerated", label: "Total Electricity Generated by RE Technology (Solar + Wind + Others) (kWh)", widthPx: 280 },
                        { key: "builtUpArea", label: "Total Built-up Area (Sq. ft.)", widthPx: 200 }
                    ]}
                    data={[
...
const conservationReports = [
    { id: 1, text: "Energy Conservation Measures", url: "#" },
    { id: 2, text: "Green Audit Report (25.02.2023)", url: "#" },
    { id: 3, text: "Energy Audit Report (FY 2021-22)", url: "#" },
    { id: 4, text: "Energy Audit Report (FY 2020-21)", url: "#" },
    { id: 5, text: "Energy Audit Manual", url: "#" },
    { id: 6, text: "Green Audit / Environmental Audit Manual", url: "#" },
    { id: 7, text: "MoU Signed with New Gurukul Education Society (NGES)", url: "#" },
    { id: 8, text: "Policy Guidelines For Environmental Sustainability", url: "#" },
    { id: 9, text: "Geo-Tagged Photos", url: "#" },
];

const eventReports = [
    { id: 1, text: "Expert Talk on “Electric Vehicles: Modern Technologies and Trends (EBLU)”", url: "#" },
    { id: 2, text: "Guest Lecture on “Heat Transfer Through Finite Difference”", url: "#" },
    { id: 3, text: "Guest Lecture on “Power System Protection”", url: "#" },
    { id: 4, text: "Guest Lecture on “Solar Power Generation”", url: "#" },
    { id: 5, text: "International Conference on “Emerging Technologies for Sustainable Development” (ICETSD-2025)", url: "#" },
];
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-10">
                    {conservationReports.map((report) => (
                        <QuickLinkCard
                            key={report.id}
                            title={report.text}
                            description="Official report regarding energy conservation and renewable energy."
                            showReadMore={false}
